...
class SurveysDb {
    ...
    companion object {
        ...
        const val ApellidoP_E   ="ApellidoPaterno"
        const val ApellidoM_E   ="ApellidoMaterno"
        ...
        const val UserId_E      ="User"
        const val Date_E        ="Fecha"
    ...
    fun  encuestasAdd(Encuesta: EntityEncuesta): Long{
        ...
        values.put(Date_E,Encuesta.fecha)
    ...
    fun encuestasGetAll(){
        ...
        val fields = arrayOf(ID, NombreE,ApellidoP_E, ApellidoM_E,
                            ...
                            Experiencia_E, Ejecutiva_E, Economica_E,
                            Promo_E, Servicio_E, Mejora_E, Ofertas_E,
                            UserId_E, Date_E)
